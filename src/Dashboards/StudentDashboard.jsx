    ...
    return (
        <div className='mx-6 pt-20'>
            <div className='text-center my-4'>
                ...
                <button className={` p-3 w-40 rounded-tr-lg rounded-br-lg transition-colors duration-300 border-r ${status === "history" ? 'bg-[#fad932] font-semibold ' : 'bg-zinc-400'} `} >Payment History</button>
            </div>
